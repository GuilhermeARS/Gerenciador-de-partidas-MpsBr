...
public class FabricaConexao {
    ...
    public FabricaConexao(){ // método construtor
    } 
    
    /** 
     * método que inicia a conexão
     * O método é static, pois não poderemos ter mais que uma conexão ao 
     * Banco de Dados usando a aplicação
     */ 
